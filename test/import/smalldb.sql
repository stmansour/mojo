...
INSERT INTO `EGroup` VALUES (1,'FAA','Employees of the Federal Aviation Administration','2017-05-02 00:14:52','2017-05-02 00:15:02','2017-05-02 00:15:02',0),(2,'MojoTest','Steve-only test group','2020-08-16 05:00:34','2020-08-16 05:00:34','2020-08-16 05:00:33',0),(3,'AmazonTest','Steve + Amazon test accounts','2020-08-16 05:00:34','2020-08-16 05:00:34','2020-08-16 05:00:33',0),(4,'AccordTest','Steve + Amazon test + Accord accounts','2020-08-16 05:00:34','2020-08-16 05:00:34','2020-08-16 05:00:33',0),(5,'SteveJoe','Steve + Joe accounts','2020-08-16 05:00:34','2020-08-16 05:00:34','2020-08-16 05:00:33',0);
...
INSERT INTO `PGroup` VALUES (1,1,'2017-05-02 00:14:55',0),(2,1,'2017-05-02 00:14:56',0),(3,1,'2017-05-02 00:14:56',0),(4,1,'2017-05-02 00:14:56',0),(5,1,'2017-05-02 00:14:57',0),(6,1,'2017-05-02 00:14:57',0),(7,1,'2017-05-02 00:14:58',0),(8,1,'2017-05-02 00:14:58',0),(9,1,'2017-05-02 00:15:00',0),(10,1,'2017-05-02 00:15:02',0),(11,2,'2020-08-16 05:00:33',0),(12,2,'2020-08-16 05:00:33',0),(11,3,'2020-08-16 05:00:33',0),(12,3,'2020-08-16 05:00:33',0),(13,3,'2020-08-16 05:00:33',0),(14,3,'2020-08-16 05:00:33',0),(15,3,'2020-08-16 05:00:33',0),(11,4,'2020-08-16 05:00:33',0),(12,4,'2020-08-16 05:00:33',0),(13,4,'2020-08-16 05:00:33',0),(14,4,'2020-08-16 05:00:33',0),(15,4,'2020-08-16 05:00:33',0),(16,4,'2020-08-16 05:00:33',0),(17,4,'2020-08-16 05:00:33',0),(11,5,'2020-08-16 05:00:33',0),(12,5,'2020-08-16 05:00:33',0),(16,5,'2020-08-16 05:00:33',0);
...
INSERT INTO `Query` VALUES (1,'MojoTest','Steve-only test group','SELECT People.* FROM People INNER JOIN PGroup ON PGroup.PID=People.PID AND PGroup.GID=2 WHERE People.Status=0','2020-08-16 05:00:33',0),(2,'AmazonTest','Steve + Amazon test accounts','SELECT People.* FROM People INNER JOIN PGroup ON PGroup.PID=People.PID AND PGroup.GID=3 WHERE People.Status=0','2020-08-16 05:00:33',0),(3,'AccordTest','Steve + Amazon test + Accord accounts','SELECT People.* FROM People INNER JOIN PGroup ON PGroup.PID=People.PID AND PGroup.GID=4 WHERE People.Status=0','2020-08-16 05:00:33',0),(4,'SteveJoe','Steve + Joe accounts','SELECT People.* FROM People INNER JOIN PGroup ON PGroup.PID=People.PID AND PGroup.GID=5 WHERE People.Status=0','2020-08-16 05:00:33',0),(5,'FAA','The first 50 people in the FAA','SELECT People.* FROM People INNER JOIN PGroup ON PGroup.PID=People.PID AND PGroup.GID=1 WHERE People.Status=0','2020-08-16 05:00:33',0);
...
-- Dump completed on 2020-08-15 22:00:33
