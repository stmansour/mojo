...
dojsonAwsPOST "http://localhost:8275/v1/aws" "request" "h"  "WebService--AWS-BounceNotification" "Notification"
...
dojsonAwsPOST "http://localhost:8275/v1/aws" "request" "i"  "WebService--AWS-SuppressionList" "Notification"

# Optout FAIL
doHtmlGET "http://localhost:8275/v1/optout?e=sman@accordinterests.com&c=ad7a567ae84ea687b23f74c5e18f0ce" "j"  "WebService--OptOut-fail"

# Optout SUCCESS
doHtmlGET "http://localhost:8275/v1/optout?e=sman@accordinterests.com&c=9010fb3ff00db43ebd891bc39d8dafc8" "k"  "WebService--OptOut-success"
